...
function densidadeDemo(area, populacao) {
...
estadosUf.push('Sergipe')

estadosUf.unshift('Alagoas')

estadosUf.splice(1, 0, 'Rio Grande do Norte')

estadosUf.splice(2, 0, 'Paraíba')

estadosUf.splice(3, 0, 'Pernambuco')

estadosUf.splice(1, 0, 'Ceará')

estadosUf.splice(5, 0, 'Piauí')

estadosUf.splice(2, 0, 'Maranhão')

estadosUf.splice(1, 0, 'Bahia')
